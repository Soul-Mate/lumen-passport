...
class RouteRegistrar
{
    ...
    {
        $this->app->post('/token',
            $this->prefix('\YuanChang\LumenPassport\Http\Controllers\AccessTokenController@issueToken'));

        $this->app->post("/mobile/token",
            $this->prefix('\YuanChang\LumenPassport\Http\Controllers\MobileAccessTokenController@issueToken'));
