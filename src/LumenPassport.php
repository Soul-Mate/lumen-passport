...
class LumenPassport
{
    ...
    /**
     * @desc extend mobile checker
     * @param MobileChecker $checker
     * @author Yuanchang (yuanchang.xu@outlook.com)
     * @since 2018/4/12
     */
    public static function extendChekMobileChecker(MobileChecker $checker)
    {
        app()->singleton(MobileChecker::class, function($app){
            return new $checker;
        });
    }
}
